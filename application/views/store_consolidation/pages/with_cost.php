...
<!-- page break !-->  
                <div class="tab">
                  <button class="tablinks" onclick="tab_setup(event, 'Monthly')"id="defaultOpen"> Consolidate w/ Cost </button>
                  <button class="tablinks" onclick="tab_setup(event, 'Update')">generate report</button>
                </div>
